...
import { removePages, downloadFile } from '@/lib/api';
...
export default function RemovePagesPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            downloadFile(blob, `modified_${file.name}`);
            setSuccess(true);
        } catch (err) {
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                disabled={loading}
                            />
                            <p className="text-xs text-zinc-500 mt-1">Enter page numbers to delete (e.g., 1,3-5,7)</p>
                        </div>
                        ...
                        {success && (
                            <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md">
                                <p className="text-sm text-green-800 dark:text-green-300">
                                    Pages removed successfully! File downloaded.
                                </p>
                            </div>
                        )}
                    </div>
