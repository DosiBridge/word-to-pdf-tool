...
import { extractPages, downloadFile } from '@/lib/api';
...
export default function ExtractPagesPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            downloadFile(blob, `extracted_${file.name}`);
            setSuccess(true);
        } catch (err) {
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                disabled={loading}
                            />
                            <p className="text-xs text-zinc-500 mt-1">Use commas for individual pages, dashes for ranges (e.g., 1,3-5,7)</p>
                        </div>
                        ...
                        {success && (
                            <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md">
                                <p className="text-sm text-green-800 dark:text-green-300">
                                    Pages extracted successfully! File downloaded.
                                </p>
                            </div>
                        )}
                    </div>
